...
<h1 class="a">Enter Details ...  </h1>
<form action="buy" class="div1">
<table>
<tr><td class="b">Name</td> <td><input type="text" name="name" class="b" required></td></tr>
<tr><td class="b">Movie Name</td> <td><input type="text" name="medicine" class="b" required></td></tr>
...
<tr><td><input type="submit" value="Book Ticket Now" class="in"></td></tr>
</table>
</form>
</body>
</html>